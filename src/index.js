  ...
  return {
    ...
    contact: R.compose(
      R.ifElse(R.complement(R.isNil), $contactDetailsRow => ({
        ...
        )($contactDetailsRow.find('> dd.col-xs-12:nth-of-type(2)').text().trim()),
        fax: R.compose(
          R.curryN(2, formatPhoneNumber)(R.__, 'E.164'),
          R.curryN(2, parsePhoneNumber)(R.__, { defaultCountry: 'CA' }),
        )($contactDetailsRow.find('> dd.col-xs-12:nth-of-type(3)').text().trim()),
      ...
      R.find($row => R.contains($row.find('> dt.col-xs-12:nth-of-type(1)').text().trim(), ['Business address', 'Adresse d\'affaires'])),
    )([$detailsCol.find('> dl.row.section-dl:nth-of-type(3)'), $detailsCol.find('> dl.row.section-dl:nth-of-type(4)')]),
  };
}
...
export {
  AREAS_OF_PRACTICE_EN,
  AREAS_OF_PRACTICE_FR,
  getAgencyDetails,
  getBrokerDetails,
  LANGUAGES,
  listBrokers,
