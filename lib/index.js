...
async function getBrokerDetails({
  ...
  const $agencyDetailsRow = $detailsCol.find('> dl.row.section-dl:nth-of-type(2)');
  ...
  return {
    ...
    agency: R.ifElse(R.contains(R.__, ['Agency', 'Agence']), () => ({
      ...
      corporateName: $agencyDetailsRow.find('> dd.col-xs-12:nth-of-type(2)').text().trim(),
    ...
    contact: R.compose(R.ifElse(R.complement(R.isNil), $contactDetailsRow => ({
      ...
      telephone: R.compose(R.curryN(2, formatPhoneNumber)(R.__, 'E.164'), R.curryN(2, parsePhoneNumber)(R.__, { defaultCountry: 'CA' }))($contactDetailsRow.find('> dd.col-xs-12:nth-of-type(2)').text().trim()),
      fax: R.compose(R.curryN(2, formatPhoneNumber)(R.__, 'E.164'), R.curryN(2, parsePhoneNumber)(R.__, { defaultCountry: 'CA' }))($contactDetailsRow.find('> dd.col-xs-12:nth-of-type(3)').text().trim()),
    ...
    }), R.always(null)), R.find($row => R.contains($row.find('> dt.col-xs-12:nth-of-type(1)').text().trim(), ['Business address', 'Adresse d\'affaires'])))([$detailsCol.find('> dl.row.section-dl:nth-of-type(3)'), $detailsCol.find('> dl.row.section-dl:nth-of-type(4)')])
  };
}
