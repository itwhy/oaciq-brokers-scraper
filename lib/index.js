...
async function getBrokerDetails({
  ...
  const $forwho = $detailsCol.find('> dl.row.section-dl:nth-of-type(2) > dd.col-xs-12:nth-of-type(3)');
  const $area = $detailsCol.find('> dl.row.section-dl:nth-of-type(2) > dd.col-xs-12:nth-of-type(1)');
  const $address = $detailsCol.find('> dl.row.section-dl:nth-of-type(5) > dd.col-xs-12:nth-of-type(1)');
  ...
  return {
    ...
    contact: R.compose(R.ifElse(R.complement(R.isNil), $contactDetailsRow => ({
      ...
      telephone: R.ifElse(R.complement(R.contains(R.__, notAvailableTexts)), R.compose(R.curryN(2, formatPhoneNumber)(R.__, 'E.164'), R.curryN(2, parsePhoneNumber)(R.__, {
        defaultCountry: 'CA'
      })), R.always(null))($contactDetailsRow.find('> dd.col-xs-12:nth-of-type(2)').text().trim()),
      fax: R.ifElse(R.complement(R.contains(R.__, notAvailableTexts)), R.compose(R.curryN(2, formatPhoneNumber)(R.__, 'E.164'), R.curryN(2, parsePhoneNumber)(R.__, {
        defaultCountry: 'CA'
      })), R.always(null))($contactDetailsRow.find('> dd.col-xs-12:nth-of-type(2)').text().trim()),
    ...
    }), R.always(null)), R.find($row => R.contains($row.find('> dt.col-xs-12:nth-of-type(1)').text().trim(), ['Business address', 'Adresse professionnelle'])))([$detailsCol.find('> dl.row.section-dl:nth-of-type(1)'), $detailsCol.find('> dl.row.section-dl:nth-of-type(1)')])
  };
}
...
async function getAgencyDetails({
  ...
  const $contactDetailsRow = $detailsCol.find('> dl.row.section-dl:nth-of-type(3)');
  ...
  return {
    ...
    contact: {
      ...
      fax: R.ifElse(R.complement(R.contains(R.__, notAvailableTexts)), R.compose(R.curryN(2, formatPhoneNumber)(R.__, 'E.164'), R.curryN(2, parsePhoneNumber)(R.__, {
        defaultCountry: 'CA'
      })), R.always(null))($contactDetailsRow.find('> dd.col-xs-12:nth-of-type(3)').text().trim()),
